...
1. Used Power Query to clean, transform, and integrate syndicated and internal datasets for customized reporting and analysis.
...
## Demonstrated Skills
1. Syndicated Datasets: Market Selection, KPI Development, Clustering, Aggregation, Reusable Reporting Extracts
1. Power Query: Data Validation, Null/Outlier Handling, Normalization, Transformation, Deduplication, Joins, Data Splitting
1. Excel & Dashboarding: Pivot Tables, Calculated Fields, Data Visualization, Filters, Slicers, KPI Tracking, Benchmarking, Dashboard Design, Stakeholder Reporting
1. Business Analysis: Sales Performance Analysis, Promotional Effectiveness Analysis, Seasonal Trend Analysis, Pricing Analysis
1. Other Skills: Problem Framing, Requirements Gathering, Scoring Methodologies, Reusable Dashboard Development, Strategic Recommendations, Stakeholder Collaboration

## Case 2: National Drug
### Executive Summary
...
1. Weekly sales trends showed heavy dependence on short-term promotional spikes with limited sustained baseline growth
